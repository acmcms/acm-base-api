...
public interface StorageAPI {
	...
	Value<? extends Collection<? extends Record>> getContainers(
			...
			final TreeLinkType linkageMode);
	 ...
	 * @return result
	 */
	Value<? extends Record> getContentByKey(final Record record, final String linkageKey, final TreeLinkType linkageMode);
	 ...
	 * @return result
	 */
	Value<? extends Collection<? extends Record>> getContents(final Record record, final TreeLinkType linkageMode);
