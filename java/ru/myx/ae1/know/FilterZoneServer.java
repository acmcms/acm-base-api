 ...
 *
 */
public class FilterZoneServer extends FilterServer implements ZoneServer {
	
	/**
	 *
	 */
	protected final ZoneServer parent;

	/**
	 * @param parent
	 * @throws NullPointerException
	 */
	public FilterZoneServer(final ZoneServer parent) throws NullPointerException {
		super(parent);
		this.parent = parent;
	}
	...
	public Share<?>[] filterAllowedShares(final Share<?>[] sharings) {
		...
		return this.parent.filterAllowedShares(sharings);
	}
	...
	public ControlNode<?> getControlNodeForShare(final String share) {
		...
		return this.parent.getControlNodeForShare(share);
	}
	...
	public Share<?>[] getSharings() {
		...
		return this.parent.getSharings();
	}
	...
	public Entry getVfsZoneEntry() {
		...
		return this.parent.getVfsZoneEntry();
	}

	@Override
	public Entry getVfsZoneLibEntry() {
		
		return this.parent.getVfsZoneLibEntry();
	}
	...
	public Entry requireResolveVfsModule(final String moduleName) {
		...
		return this.parent.requireResolveVfsModule(moduleName);
	}

	@Override
	public Entry requireResolveVfsEntry(final String pathName) {
		
		return this.parent.requireResolveVfsEntry(pathName);
	}
