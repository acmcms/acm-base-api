...
final class CompactDateFormatterIntl {
	...
	static final class Formatter {
		...
		private static final Object UNDEFINED = MultivariantString.getString("n/a", Collections.singletonMap("ru", "нет данных"));

		private static final Object TODAY = MultivariantString.getString("today", Collections.singletonMap("ru", "сегодня"));

		private static final Object YESTERDAY = MultivariantString.getString("yesterday", Collections.singletonMap("ru", "вчера"));
