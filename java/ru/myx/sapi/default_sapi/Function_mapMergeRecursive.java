...
/** @author myx */
public final class Function_mapMergeRecursive extends BaseFunctionAbstract implements ExecCallableBoth.NativeJ2 {
	...
	private final void copyDeep(final Map<String, Object> source, final Map<String, Object> target) {
		...
		for (final String key : source.keySet()) {
			...
			final Object other = target.get(key);
			if (other instanceof Map<?, ?> && value instanceof Map<?, ?>) {
				final Map<String, Object> recipient = Convert.Any.toAny(other);
				final Map<String, Object> data = Convert.Any.toAny(value);
				this.copyDeep(data, recipient);
			} else {
